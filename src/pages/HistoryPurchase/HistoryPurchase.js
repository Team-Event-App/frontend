...
import { Table, Container,Form,FormControl,Button,Row,Col} from "react-bootstrap";
    ...
    return (
            ...
            <tbody>
              <tr>
                ...
                <td>Rp.25000</td>
                <td>Zoom</td>
                <td><img src={Event1} className='imageTable'/></td>
                <td><Button variant="primary" className="invoiceButton">Invoice</Button></td>
              </tr>
              <tr>
                <td>2</td>
                ...
                <td>Free</td>
                <td>Online Live</td>
                <td><img src={Event2} className='imageTable'/></td>
                <td><Button variant="primary" className="invoiceButton">Invoice</Button></td>
              </tr>
              <tr>
                <td>3</td>
                ...
                <td>45.000</td>
                <td>Online</td>
                <td><img src={Event3} className='imageTable'/></td>
                <td><Button variant="primary" className="invoiceButton">Invoice</Button></td>
              </tr>
            </tbody>
          </Table>
